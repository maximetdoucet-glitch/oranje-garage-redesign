        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          <div>
            ...
            <h2 className="display mt-6 text-[clamp(2.5rem,6vw,5rem)] leading-[0.95]">
              {c.headlineLines[0]}
              <br />
              <span className="text-accent">{c.headlineLines[1]}</span>
            </h2>
            ...
            <div className="mt-12 space-y-10">
              <div>
                ...
                <div className="display text-3xl text-fg-muted">
                  {c.address.line2}
                </div>
                <a
                  href={c.mapsUrl}
                  target="_blank"
                  rel="noopener"
                  className="mono mt-3 inline-block text-[11px] tracking-[0.2em] text-accent underline-offset-4 hover:underline"
                >
                  ROUTE OPENEN →
                </a>
              </div>
              ...
              <div>
                ...
                <a
                  href={c.phoneHref}
                  className="display mt-3 block text-3xl hover:text-accent"
                >
                  {c.phoneDisplay}
                </a>
                <a
              ...
              <div>
                ...
                <a
                  href={`mailto:${c.email}`}
                  className="display mt-3 block text-2xl hover:text-accent"
                >
                  {c.email}
                </a>
              </div>
          ...
          <div className="relative aspect-square overflow-hidden rounded-sm border border-border lg:aspect-auto">
            <iframe
              ...
              style={{
                filter:
                  "invert(0.92) hue-rotate(180deg) grayscale(1) contrast(1.1)",
              }}
              loading="lazy"
            />
            <div className="pointer-events-none absolute bottom-6 left-6 right-6 rounded-sm border border-border-strong bg-bg/85 p-5 backdrop-blur">
              <div className="label">· COÖRDINATEN ·</div>
              <div className="display mt-2 text-xl">{c.coordinates}</div>
              <div
                className="mono mt-2 text-[10px] tracking-[0.2em]"
